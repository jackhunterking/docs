...
3. (Recommended) In debug/test mode, embed a small `browser_pixel` object in the CAPI request payload so AdsGateway Logs can show `Pixel: sent/blocked/unknown`.
