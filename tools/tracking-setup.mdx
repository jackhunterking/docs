...
2. Send test event with `setup_meta_tracking` verify step or `meta_tracking_verify`.
3. Run `meta_tracking_setup_audit` to detect configuration gaps, event drift, and failures.
